...
parser.add_argument("--learning_rates", nargs="+", type=float, default=[1e-5, 1e-4, 1e-3], help="Learning rates for the optimizer.")
...
parser.add_argument("--dropout_p", nargs="+", type=float, default=[0.3, 0.4, 0.5], help="Dropout probabilities.")
...
non_snp_columns = data[['IID', 'array01', 'sex', 'age', 'pop_pc1', 'pop_pc2', 'pop_pc3',
       'pop_pc4', 'pop_pc5', 'pop_pc6', 'pop_pc7', 'pop_pc8', 'pop_pc9',
       'pop_pc10', 'int_phenotype', 'split1', 'split3']]  # First three columns
snp_data = data.drop(columns=['IID', 'array01', 'sex', 'age', 'pop_pc1', 'pop_pc2', 'pop_pc3',
       'pop_pc4', 'pop_pc5', 'pop_pc6', 'pop_pc7', 'pop_pc8', 'pop_pc9',
       'pop_pc10', 'int_phenotype', 'split1', 'split3'])  # SNP data for encoding
