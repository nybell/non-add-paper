...
OUT = "/Users/nyb/phd_code/dl-prs-v2/data/nyb_sims_data_v2/syn_phenos/fams_fin_snps500"
snp.file = "/Users/nyb/phd_code/dl-prs-v2/data/nyb_sims_data_v2/syn_phenos/fams_fin_snps500/snps.500.RData"
config_file = "/Users/nyb/phd_code/dl-prs-v2/data/nyb_sims_data_v2/syn_phenos/fams_fin_snps500/sim.fin.config.snps500.csv"
...
for (i in 1:nrow(grid)) {
  ...
  pheno.result = gen.sim.pheno(snps.500, genos1, genos2,
