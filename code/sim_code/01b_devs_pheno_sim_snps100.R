...
OUT = "/Users/nyb/phd_code/dl-prs-v2/data/nyb_sims_data_v2/syn_phenos/domdevs_snps100"
snp.file = "/Users/nyb/phd_code/dl-prs-v2/data/nyb_sims_data_v2/syn_phenos/fams_fin_snps100/snps.100.RData"
config_file = "/Users/nyb/phd_code/dl-prs-v2/data/nyb_sims_data_v2/syn_phenos/domdevs_snps100/domdevs.config.snps100.csv"
...
# gen.sim.pheno(n.linear.snps, snp.freqs, genos1, 
# genos2, total.h2, addit.h2, domin.h2, AA = 1, Aa.add = 0.5, Aa.dev = 0.25)
...
for (i in 1:nrow(grid)) {
  ...
  print(paste("Running sim:", total.h2, "( Aa ADD:", 0.5, ", Aa DEV:", Aa.dev, ", SNPs:", n.linear.snps, ")"))
  ...
  fam1.base = paste("eur", "devsim", Aa.dev, nsnps, h, a, d, s1, sep = "_")
  fam1.out = file.path(full.h.out, paste0(fam1.base, ".fam"))
  fam2.base = paste("eur", "devsim", Aa.dev, nsnps, h, a, d, s2, sep = "_")
  fam2.out = file.path(full.h.out, paste0(fam2.base, ".fam"))
  log.file = file.path(full.h.out, paste("log", "devsim", Aa.dev, nsnps, h, a, d, ".txt", sep = "_"))
  sim.out = file.path(full.sims.h.out, paste0("SIM_", "devsim", Aa.dev, nsnps, "_", h, "_", a, "_", d, "_", s1, ".json"))
  snps.s2.out = file.path(full.h.out, paste0("devsim", "_", Aa.dev, "_", nsnps, "_", h, "_", a, "_", d, "_", s2, ".RData"))
  ...
  pheno.result = gen.sim.pheno(snps.100, genos1, genos2,
                                total.h2, addit.h2, domin.h2,
                                AA = 1, Aa.add = 0.5, Aa.dev = Aa.dev)
  print(" <<>> -- DONE -- <<>>")
