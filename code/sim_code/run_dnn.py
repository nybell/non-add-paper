...
from model_definition import DNN, DNNObjective, adjusted_r2, split_data, get_architecture_params
...
parser.add_argument("--dropout_p", nargs="+", type=float, default=[0.0, 0.25, 0.5], help="Dropout probabilities.")
...
print(" >> Average model performance:", test_df['r2'].mean(), " << \n")
# save results
